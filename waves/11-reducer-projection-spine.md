...
depends_on = [10]
validation = ["cargo test -p wave-reducer -p wave-gates -p wave-projections", "cargo test -p wave-control-plane -p wave-app-server -p wave-tui --locked", "cargo run -p wave-cli -- doctor --json", "cargo run -p wave-cli -- control status --json"]
...
proof = ["Cargo.toml", "crates/wave-reducer/src/lib.rs", "crates/wave-gates/src/lib.rs", "crates/wave-projections/src/lib.rs", "crates/wave-control-plane/src/lib.rs", "crates/wave-cli/src/main.rs", "crates/wave-app-server/src/lib.rs", "crates/wave-tui/src/lib.rs", "docs/implementation/rust-codex-refactor.md", "docs/guides/terminal-surfaces.md", "docs/plans/master-plan.md", "docs/plans/current-state.md", "docs/plans/migration.md", "docs/plans/component-cutover-matrix.md", "docs/plans/component-cutover-matrix.json"]
+++
