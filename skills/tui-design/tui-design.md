...
This reference distills `docs/world-class-tui.md` into reusable design guidance for Wave's terminal UX and operator-review work.
...
## How to use this reference in Wave

For Wave specifically, apply these principles to:

- operator shell layout
- queue and control surfaces
- blocker triage
- proof and acceptance drill-down
- multi-wave concurrency visibility
- orchestrator action and approval UX

When reviewing, tie findings back to:

- exact surface
- exact interaction
- operator risk
- whether the issue is blocking or advisory

Use this reference together with:

- `docs/implementation/design.md`
- `docs/world-class-tui.md`
