...
Use this skill when the work involves terminal UX, operator shells, or live TUI review.
...
For the full world-class TUI design guidance distilled for this repo, read:
