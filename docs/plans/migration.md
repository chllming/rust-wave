...
- The next executable cutover is Wave 12: land structured result envelopes and proof lifecycle so closure input, proof summaries, and doc-delta state stop depending directly on free-form marker scanning while legacy adapters remain explicit and replay ratification stays later work.
